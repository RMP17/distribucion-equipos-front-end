    ...
    <div v-if="printData && printData.equipos" class="section-to-print">
        <div ref="printArea">
            ...
            >
                ...
                <tr v-for="value in printData.equipos">
                    <template v-if="value.tipo==='e'">
                        <td class="caption">
                            {{value.descripcion}}
                            <span v-for="accesorio in value.accesorios">+{{ accesorio.tipo_accesorio }}</span>
                        </td>
            ...
            >
                ...
                <tr>
                    <td style="background: blanchedalmond" colspan="2">RECIBIDO POR : {{ printData.tecnico ? printData.tecnico.nombre:'' }}</td>
...
<script>
    export default {
        ...
        methods: {
            printAsignacion(){
                if(this.printData && this.printData.kit){
